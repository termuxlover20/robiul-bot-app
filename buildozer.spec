...
title = Robiul Signal Bot

# (str) Package name
package.name = robiulbot
...
#       [app]
#       title = Robiul Signal Bot # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = Robiul Signal Bot
#          package.name = robiulbot # This is all part of the title.
#
